...
- **Brute force:** <Didn't bother> — O(n²) time, O(n) space
...
- **C# notes:** <Indexing a fixed int[201] array directly by the char value (char auto-converts to int) acts as a fast fixed-size counter — cheaper than a HashSet.>

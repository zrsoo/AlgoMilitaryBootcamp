...
| 4 | 2026-07-12 | Sun | 04 Caching | written + taught (07-12) — quiz next session |
...
| 04 | Caching (patterns, invalidation, stampede/hot keys) | ✅ v1.0 | ✅ taught 07-12 | — | Under sourcing directive: [S1]–[S4] (Redis eviction, Azure cache-aside, AWS ElastiCache, Cloudflare CDN). Quiz next session (integrative w/ L01–L03). |

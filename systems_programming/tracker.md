...
|---|--------|-----------------|---------|---------|---------|-------|
| 01 | Threads & execution model (process vs thread, Thread/Task/pool, scheduling, context switch, concurrency vs parallelism, why concurrency) | `01-threads` | ✅ v1.0 (07-14) | — | — | Written to full depth, sourced (MS Learn [S1–S4],[S7]). Demo: spin up threads, observe interleaving. **Taught 07-14.** Quiz next session. |
| 02 | Shared state & race conditions | `02-races` (planned) | — | — | — | planned |

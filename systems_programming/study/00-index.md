...
| 03 | 03-mutual-exclusion-locks.md *(planned)* | mutex/lock, spinlock, lock granularity, contention; deadlock (4 conditions), livelock, lock ordering | fix L2's race; force + fix a deadlock |
